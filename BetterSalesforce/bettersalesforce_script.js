...
function initRows() {
    console.log("Inside the initRows method...")
...
function addLinksToRows(case_rows) {
    console.log("Inside the addLinksToRows method");
    for (var i in case_rows) {
...
function createCaseLinks(sf_id, jive_case_url) {
    console.log("Inside the createCaseLinks method");
...
function createCaseLinksFrontline(sf_id, jive_case_url) {
    console.log("Inside the createCaseLinksFrontline method");
...
function createCaseLinksAccountSupport(sf_id, jive_case_url) {
    console.log("Inside the createCaseLinksAccountSupport method");
...
function insertCaseLinks(dom, sf_id, links) {
    console.log("Inside the insertCaseLinks method")
    ...
    if (caseLinks[sf_id]) {
        ...
        for (var i = 0; i < 6 && !added; ++i)
        {
            setTimeout(function () {
                ...
                //Set up ajax request
                console.log("Starting to build AJAX request");
...
function getCaseRows() {
    console.log("Starting to use getCaseRows...");
